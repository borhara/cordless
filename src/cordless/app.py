...
def _check_description(where: str, text: str | None) -> None:
...
def _validate_command_shape(
    name: str, description: str | None, options: Any, group_description: str | None = None
) -> None:
    ...
    for opt in options:
        ...
        choices: Any = opt.get("choices") or []
...
def options_from_signature(func: Any) -> list[dict[str, Any]]:
    ...
    for p in params:
        ...
        opt: dict[str, Any] = {"name": p.name, "description": "No description provided."}
...
def choice(name: str, value: Any, name_localizations: Any = None) -> dict[str, Any]:
    ...
    c: dict[str, Any] = {"name": name, "value": value}
...
class Cordless(RESTMixin):
    ...
    async def _discord_request(self, method: str, path: str, payload: Any = None, files: Any = None) -> Any:
    ...
    async def send_message(
        self, channel_id: str, content: Any = None, *, embeds: Any = None, components: Any = None, files: Any = None
    ) -> Any:
    ...
    async def delete_webhook_message(
        self, webhook_id: str, webhook_token: str | None = None, message_id: str = "@original"
    ) -> Any:
    ...
    async def fetch_webhook_with_token(self, webhook_id: str, webhook_token: str | None = None) -> Any:
    ...
    async def add_role(self, guild_id: str, user_id: str, role_id: str, *, reason: str | None = None) -> Any:
    ...
    async def remove_role(self, guild_id: str, user_id: str, role_id: str, *, reason: str | None = None) -> Any:
    ...
    async def create_webhook(self, channel_id: str, name: str, avatar: Any = None, *, reason: str | None = None) -> Any:
    ...
    def handler(self) -> Any:
        ...
        def _handler(event: Any, context: Any = None) -> Any:
            event = event or {}
    ...
    def cron(self, schedule: str, name: str | None = None) -> Callable[[Any], Any]:
    ...
    def run_cron(self, name: str) -> Any:
    ...
    def button(self, custom_id: str, defer: bool = False) -> Callable[[Any], Any]:
    ...
    def select(self, custom_id: str, defer: bool = False) -> Callable[[Any], Any]:
    ...
    def modal(self, custom_id: str, defer: bool = False) -> Callable[[Any], Any]:
    ...
    def autocomplete(self, cmd_name: str, option_name: str | None) -> Callable[[Any], Any]:
    ...
    def route(self, method: str, path: str) -> Callable[[Any], Any]:
    ...
    def guard(self, fn: Any) -> Callable[[Any], Any]:
    ...
    def handle(self, event: Any, context: Any = None) -> dict[str, Any] | None:
        ...
        if self.public_key is not None:
            headers = cast("dict[str, Any]", event.get("headers") or {})
    ...
    def _try_route(self, event: Any) -> dict[str, Any] | None:
    ...
    def sync_commands(
        self, bot_token: Any = None, client_id: Any = None, client_secret: Any = None, guild_id: Any = None
    ) -> Any:
...
def _extract_body(event: Any) -> Any:
    body = event.get("body", "")
