...
class Permissions:
    ...
    def __init__(self, raw: str | int | None = 0, **flags: bool) -> None:
...
def _cdn_asset_url(path: str, image_hash: str | None) -> str | None:
...
class User(DiscordObject):
    ...
    async def create_dm(self, **kwargs: Any) -> Any:
...
class Member(DiscordObject):
    ...
    async def add_role(self, role_id: str, **kwargs: Any) -> Any:
    ...
    async def remove_role(self, role_id: str, **kwargs: Any) -> Any:
    ...
    async def timeout(self, until: Any, **kwargs: Any) -> Any:
...
class Message(DiscordObject):
    ...
    async def crosspost(self, **kwargs: Any) -> Any:
    ...
    async def add_reaction(self, emoji: str, **kwargs: Any) -> Any:
    ...
    async def remove_reaction(self, emoji: str, user_id: str | None = None, **kwargs: Any) -> Any:
    ...
    async def fetch_reactions(self, emoji: str, **kwargs: Any) -> Any:
    ...
    async def clear_reactions(self, emoji: str | None = None, **kwargs: Any) -> Any:
    ...
    async def fetch_poll_answer_voters(self, answer_id: str, **kwargs: Any) -> Any:
    ...
    async def expire_poll(self, **kwargs: Any) -> Any:
...
class Channel(DiscordObject):
    ...
    async def start_thread_from_message(self, message_id: str, name: str, **kwargs: Any) -> Any:
    ...
    async def start_thread_without_message(self, name: str, **kwargs: Any) -> Any:
    ...
    async def start_thread_from_forum(self, name: str, *, message: str, **kwargs: Any) -> Any:
    ...
    async def fetch_public_archived_threads(self, **kwargs: Any) -> Any:
    ...
    async def fetch_private_archived_threads(self, **kwargs: Any) -> Any:
    ...
    async def fetch_joined_private_archived_threads(self, **kwargs: Any) -> Any:
    ...
    async def set_permissions(self, overwrite_id: str, *, type: int, **kwargs: Any) -> Any:
    ...
    async def delete_permission(self, overwrite_id: str, **kwargs: Any) -> Any:
        """Requires MANAGE_ROLES."""
        await channels.delete_channel_permission(self.id, overwrite_id, **kwargs)

    async def fetch_invites(self, **kwargs: Any) -> Any:
    ...
    async def follow_announcement(self, webhook_channel_id: str, **kwargs: Any) -> Any:
    ...
    async def trigger_typing(self, **kwargs: Any) -> Any:
    ...
    async def set_voice_status(self, status: str | None = None, **kwargs: Any) -> Any:
        """Set (or, with `status=None`, clear) this voice channel's status."""
        await channels.set_voice_channel_status(self.id, status, **kwargs)

    async def add_recipient(self, user_id: str, access_token: str, **kwargs: Any) -> Any:
    ...
    async def bulk_delete_messages(self, message_ids: Any, **kwargs: Any) -> Any:
    ...
    async def fetch_webhooks(self, **kwargs: Any) -> Any:
    ...
    async def create_stage_instance(self, topic: str, **kwargs: Any) -> Any:
    ...
    async def fetch_stage_instance(self, **kwargs: Any) -> Any:
    ...
    async def send_soundboard_sound(self, sound_id: str, **kwargs: Any) -> Any:
...
class Guild(DiscordObject):
    ...
    @property
    def discovery_splash_url(self) -> Any:
    ...
    async def fetch_active_threads(self, **kwargs: Any) -> Any:
    ...
    async def create_channel(self, name: str, **kwargs: Any) -> Any:
    ...
    async def fetch_channels(self, **kwargs: Any) -> Any:
        """List this guild's channels, as a list of `Channel`."""
        return await channels.fetch_guild_channels(self.id, **kwargs)

    async def edit_channel_positions(self, positions: Any, **kwargs: Any) -> Any:
    ...
    async def fetch_preview(self, **kwargs: Any) -> Any:
    ...
    async def unban(self, user_id: str, **kwargs: Any) -> Any:
        """Remove a ban. Requires `BAN_MEMBERS`."""
        await guilds.remove_guild_ban(self.id, user_id, **kwargs)

    async def bulk_ban(self, user_ids: Any, **kwargs: Any) -> Any:
    ...
    async def fetch_prune_count(self, **kwargs: Any) -> Any:
    ...
    async def prune(self, **kwargs: Any) -> Any:
    ...
    async def edit_voice_state(self, **kwargs: Any) -> Any:
    ...
    async def edit_member_voice_state(self, user_id: str, **kwargs: Any) -> Any:
    ...
    async def fetch_integrations(self, **kwargs: Any) -> Any:
    ...
    async def delete_integration(self, integration_id: str, **kwargs: Any) -> Any:
    ...
    async def fetch_welcome_screen(self, **kwargs: Any) -> Any:
    ...
    async def edit_incident_actions(self, **kwargs: Any) -> Any:
    ...
    async def search_members(self, query: str, **kwargs: Any) -> Any:
    ...
    async def add_member(self, user_id: str, access_token: str, **kwargs: Any) -> Any:
    ...
    async def edit_role_positions(self, positions: Any, **kwargs: Any) -> Any:
    ...
    async def search_messages(self, **kwargs: Any) -> Any:
    ...
    async def fetch_soundboard_sounds(self, **kwargs: Any) -> Any:
        """List this guild's soundboard sounds, as a list of
        `SoundboardSound`."""
        return await soundboard.fetch_guild_soundboard_sounds(self.id, **kwargs)

    async def fetch_soundboard_sound(self, sound_id: str, **kwargs: Any) -> Any:
    ...
    async def create_soundboard_sound(self, name: str, sound: str, **kwargs: Any) -> Any:
    ...
    async def fetch_scheduled_events(self, **kwargs: Any) -> Any:
    ...
    async def create_scheduled_event(
        self, name: str, privacy_level: int, scheduled_start_time: str, entity_type: int, **kwargs: Any
    ) -> Any:
    ...
    async def fetch_scheduled_event(self, event_id: str, **kwargs: Any) -> Any:
        """Fetch a single scheduled event by id."""
        return await scheduled_events.fetch_guild_scheduled_event(self.id, event_id, **kwargs)

    async def fetch_auto_moderation_rules(self, **kwargs: Any) -> Any:
    ...
    async def fetch_auto_moderation_rule(self, rule_id: str, **kwargs: Any) -> Any:
    ...
    async def create_auto_moderation_rule(
        self, name: str, event_type: int, trigger_type: int, actions: Any, **kwargs: Any
    ) -> Any:
